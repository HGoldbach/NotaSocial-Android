...
import br.notasocial.ui.viewmodel.buscarproduto.BuscarProdutoViewModel
...
fun SearchProductScreen(
    ...
    viewModel: BuscarProdutoViewModel = viewModel(factory = AppViewModelProvider.Factory)
) {
...
fun ProductGrid(
    ...
    LazyVerticalGrid(
        ...
        items(items = products.content!!, key = { it?.id!! }) { product ->
            if (product != null) {
                SearchProductItem(
                    product = product,
                    modifier = Modifier
