package br.notasocial.ui.view.customer.signup
...
import br.notasocial.ui.viewmodel.customer.register.ProfileType
import br.notasocial.ui.viewmodel.customer.register.SignUpUiState
...
object NumberDefaults {
    const val MASK = "##.###.###/####-##"
    const val INPUT_LENGTH = 14 // Equals to "#####-###".count { it == '#' }
}
